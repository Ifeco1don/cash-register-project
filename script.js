...
//   if (parseFloat(inputElement.value) < price) {
//     alert("Customer does not have enough money to purchase the item");
//   } else if (parseFloat(inputElement.value) === price) {
...
// const formatChange = changeArray => changeArray.map(([unit, amount]) => `${unit}: ${amount.toFixed(2)}\n`).join(" ");
